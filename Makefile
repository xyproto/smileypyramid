#############################################################################
# Makefile for building: smileypyramid
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  smileypyramid.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile smileypyramid.pro -nomoc -nodepend -nocache
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = smileypyramid1.0.0
DISTDIR = /home/alexander/clones/smileypyramid/.tmp/smileypyramid1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		smileypyramid.pro  main.cpp
QMAKE_TARGET  = smileypyramid
DESTDIR       = 
TARGET        = smileypyramid
...
Makefile: smileypyramid.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		smileypyramid.pro
	$(QMAKE) -o Makefile smileypyramid.pro -nomoc -nodepend -nocache
